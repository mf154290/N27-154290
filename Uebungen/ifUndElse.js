...
let a1 = 10 // Eine Variable (z.B a1 oder zahl1) wird mit dem Wert 1 initialisiert
let b1 = 10 // Eine Variable (z.B b1 oder zahl2) wird mit dem Wert 2 initialisiert
...
if(x3 == x3){
    console.log("Der Wert von x3 und z3 ist gleich.") 
}else{
    console.log("Der Wert von x3 und z3 ist nicht gleich.")
} 
