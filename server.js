...
dbVerbindung.query('INSERT INTO kunde(idKunde, vorname, nachname, ort, kennwort, mail) VALUES (154290, "Pit", "Kiff", "BOR", "123!", "pk@web.de") ;', function (fehler) {
...
meineApp.get('/kontostandAnzeigen',(browserAnfrage, serverAntwort, next) => {              
    ...
    if(browserAnfrage.signedCookies['istAngemeldetAls']){
        ...
        dbVerbindung.query('SELECT * FROM konto WHERE idKunde = 154290;', function (fehler, result) {      
            console.log(result)
...
meineApp.post('/kontoAnlegen',(browserAnfrage, serverAntwort, next) => {              
    ...
    dbVerbindung.query('INSERT INTO konto(iban, idKunde, anfangssaldo, kontoart, timestamp) VALUES ("' + iban + '", 154290, 1, "' + kontoArt + '", NOW()) ;', function (fehler) {
